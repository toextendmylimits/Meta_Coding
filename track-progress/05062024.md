...
|. Interval List Intersections | YES | YES | Should practice again. Move the list further if its element has lower end
...
|. Interval List Intersections | Work an variant
