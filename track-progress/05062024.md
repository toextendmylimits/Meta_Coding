...
|227. Basic Calculator II | NO | YES | Memorize two approaches: 1. Use stack 2. Use lastNum and currNum we use a variable lastNumber to track the value of the last evaluated expression.
